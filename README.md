...
- 소스통합 및 통합 테스트, 오류 수정, 테스트 기록
 
> 진군: 회원가입 임계테스트, 회원수정 임계테스트, 포인트 충전 임계테스트, 장바구니 입력수정, 테스트 기록 및 정리
> 
> 민호: 결제내역 삭제 수정, 댓글 입력 수정, 비밀번호 업데이트 수정, 테스트 기록 및 정리
> 
> 도현: 상품판매 게시물 임계테스트, 상품가격/판매개수/상품원가 테스트 기록 및 정리
...
- 소스 병합 및 오류 수정, 추가의견 수정 및 추가
> 로그인 요청시, 로그인 후 로그인 전 페이지로 되돌아옴
> carousel과 상품게시물 페이지의 사진을 연결하하여 메인페이지 수정
> 이전페이지가 없거나 로그인페이지인 경우 메인페이지로 이동
> point입력값 테스트
> 상품 링크 수정, Q&A링크 헤더 수정, 메인페이지 변경, 비밀번호 변경
> 아이디/비밀번호 찾기 추가, 이메일 인증 추가
> 상품페이지 로그인 및 권한 작업
> 상품게시물 등록을 관리자권한 확인 구현 
