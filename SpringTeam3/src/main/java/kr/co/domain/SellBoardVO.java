...
public class SellBoardVO implements Serializable{
	...
	public String toString() {
		return "SellBoardVO [bnum=" + bnum + ", title=" + title + ", writer=" + writer + ", content=" + content
				+ ", name=" + name + ", cost=" + cost + ", price=" + price + ", veiwcnt=" + veiwcnt + ", bcount="
				+ bcount + ", regdate=" + regdate + ", updatedate=" + updatedate + ", gnum=" + gnum + ", files="
